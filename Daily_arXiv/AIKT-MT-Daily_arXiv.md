...
- [2021-01-01](#2021-01-01)
	- [1. Understanding and Improving Lexical Choice in Non-Autoregressive Translation](#2020-01-01-1)
  - [2. Faster Re-translation Using Non-Autoregressive Model For Simultaneous Neural Machine Translation](#2020-01-01-2)
  - [3. LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding](#2020-01-01-3)
  - [4. CMV-BERT: Contrastive multi-vocab pretraining of BERT](#2020-01-01-4)
  - [5. Understanding and Improving Encoder Layer Fusion in Sequence-to-Sequence Learning](#2020-01-01-5)
  - [6. Transformer Feed-Forward Layers Are Key-Value Memories](#2020-01-01-6)
  - [7. Reservoir Transformer](#2020-01-01-7)
  - [8. Enhancing Pre-trained Language Model with Lexical Simplification](#2020-01-01-8)
  - [9. Accurate Word Representations with Universal Visual Guidance](#2020-01-01-9)
  - [10. Improving Zero-Shot Translation by Disentangling Positional Information](#2020-01-01-10)
  - [11. Improving BERT with Syntax-aware Local Attention](#2020-01-01-11)
  - [12. Synthetic Source Language Augmentation for Colloquial Neural Machine Translation](#2020-01-01-12)
  - [13. Out of Order: How important is the sequential order of words in a sentence in Natural Language Understanding tasks?](#2020-01-01-13)
  - [14. SemGloVe: Semantic Co-occurrences for GloVe from BERT](#2020-01-01-14)
  - [15. UNIMO: Towards Unified-Modal Understanding and Generation via Cross-Modal Contrastive Learning](#2020-01-01-15)
  - [16. Directed Beam Search: Plug-and-Play Lexically Constrained Language Generation](#2020-01-01-16)
  - [17. Exploring Monolingual Data for Neural Machine Translation with Knowledge Distillation](#2020-01-01-17)
  - [18. CLEAR: Contrastive Learning for Sentence Representation](#2020-01-01-18)
  - [19. Seeing is Knowing! Fact-based Visual Question Answering using Knowledge Graph Embeddings](#2020-01-01-19)
  - [20. Towards Zero-Shot Knowledge Distillation for Natural Language Processing](#2020-01-01-20)
  - [21. Neural Machine Translation: A Review of Methods, Resources, and Tools](#2020-01-01-21)
  - [22. Linear-Time WordPiece Tokenization](#2020-01-01-22)
  - [23. XLM-T: Scaling up Multilingual Machine Translation with Pretrained Cross-lingual Transformer Encoders](#2020-01-01-23)
  - [24. How Good is Your Tokenizer? On the Monolingual Performance of Multilingual Language Models](#2020-01-01-24)
  - [25. CoCoLM: COmplex COmmonsense Enhanced Language Model](#2020-01-01-25)
  - [26. VOLT: Improving Vocabularization via Optimal Transport for Machine Translation](#2020-01-01-26)
  - [27. ERNIE-M: Enhanced Multilingual Representation by Aligning Cross-lingual Semantics with Monolingual Corpora](#2020-01-01-27)
  - [28. Revisiting Robust Neural Machine Translation: A Transformer Case Study](#2020-01-01-28)
  - [29. FDMT: A Benchmark Dataset for Fine-grained Domain Adaptation in Machine Translation](#2020-01-01-29)
  - [30. Making Pre-trained Language Models Better Few-shot Learners](#2020-01-01-30)
  - [31. Shortformer: Better Language Modeling using Shorter Inputs](#2020-01-01-31)
  - [32. Fully Non-autoregressive Neural Machine Translation: Tricks of the Trade](#2020-01-01-32)
